...
public class HistoricoController {
    ...
    @FXML private TableColumn<Historico, String> tipo;
    ...
    private void configurarColunas() {
        ...
        tipo.setCellValueFactory(new PropertyValueFactory<>("tipo_movimentacao")); // Verifique se na classe Historico está assim
    ...
    public void filtrarHistorico() {
        ...
        if (termoBusca == null || termoBusca.isEmpty()) {
            ...
            switch (tipoFiltro) {
                ...
                case "Tipo"    -> resultado = HistoricoDAO.imprimirHistoricoportipo(termoBusca);
